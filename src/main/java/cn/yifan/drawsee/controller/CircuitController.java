...
/**
 * @FileName CircuitController @Description 电路设计控制器 @Author yifan
 *
...
public class CircuitController extends BaseController {
  ...
  @Autowired private CircuitDesignService circuitDesignService;
   ...
   */
  @PutMapping("/{id}")
  public Result<Map<String, Object>> updateCircuitDesign(
      @PathVariable String id, @RequestBody CircuitDesign circuitDesign) {
    try {
      Long userId = StpUtil.getLoginIdAsLong();
      Long designId = Long.parseLong(id);
      Map<String, Object> result =
          circuitDesignService.updateCircuitDesign(userId, designId, circuitDesign);
