...
/**
 * @FileName KnowledgeBaseController @Description 知识库控制器类，作为通用入口 @Author yifan
 *
 * @date 2025-03-28 11:10
 * @update 2025-08-15 17:30 重构为通用入口，根据用户角色引导到专用控制器
 * @update 2025-09-20 15:00 移除知识点相关功能，集成RagFlow服务
 * @update 2025-10-05 14:20 优化资源上传接口，支持多种资源类型
 */
@RestController
...
public class KnowledgeBaseController {
  ...
  @SaCheckLogin
  @GetMapping("/rag/list")
  public R<List<RagKnowledgeVO>> getUserRagKnowledgeBases(
