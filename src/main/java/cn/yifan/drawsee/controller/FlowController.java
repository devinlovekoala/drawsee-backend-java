...
/**
 * @FileName FlowController @Description 流程控制器 @Author yifan
 *
...
public class FlowController {
  ...
  public ConversationShareVO createConversationShare(
      @PathVariable Long convId, @RequestBody(required = false) CreateConversationShareDTO dto) {
