...
public interface KnowledgeResourceMapper {
   ...
   * @return 资源列表
   */
  List<KnowledgeResource> getByKnowledgeBaseId(
   ...
   * @return 类型和数量的映射
   */
  List<Map<String, Object>> countResourcesByKnowledgeBaseId(
      @Param("knowledgeBaseId") String knowledgeBaseId);
   ...
   * @return 资源列表
   */
  List<KnowledgeResource> getByKnowledgeId(
      @Param("knowledgeId") String knowledgeId, @Param("isDeleted") boolean isDeleted);
}
