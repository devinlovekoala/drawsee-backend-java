...
/**
 * @FileName CourseMapper @Description 课程数据访问层 @Author yifan
 *
...
public interface CourseMapper {
   ...
   * @return 课程列表
   */
  List<Course> getByStudentId(
      @Param("studentId") Long studentId, @Param("isDeleted") boolean isDeleted);
   ...
   * @return 课程列表
   */
  List<Course> getByCreatorRole(
      @Param("creatorRole") String creatorRole, @Param("isDeleted") boolean isDeleted);
   ...
   * @return 课程列表
   */
  List<Course> getBySubjectAndCreatorRole(
   ...
   * @return 课程总数
   */
  int countBySubjectAndCreatorRole(
      @Param("subject") String subject,
      @Param("creatorRole") String creatorRole,
      @Param("isDeleted") boolean isDeleted);
   ...
   * @return 影响行数
   */
  int addKnowledgeBase(
      @Param("courseId") String courseId, @Param("knowledgeBaseId") String knowledgeBaseId);
