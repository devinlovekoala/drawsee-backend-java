...
public class CourseResourceService {
  ...
  @Autowired private CourseResourceMapper courseResourceMapper;
  ...
  public Long uploadResource(String courseId, CreateCourseResourceDTO dto, MultipartFile file) {
    ...
    String safeName =
        StringUtils.hasText(filename) ? filename : "resource-" + System.currentTimeMillis();
    String objectName =
        String.format(
            "course-resources/%s/%s/%d_%s",
            courseId,
