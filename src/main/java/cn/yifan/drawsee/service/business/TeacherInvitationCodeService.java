...
/**
 * @FileName TeacherInvitationCodeService @Description 教师邀请码服务类 @Author yifan
 *
...
public class TeacherInvitationCodeService {
  ...
  @Autowired private TeacherInvitationCodeMapper teacherInvitationCodeMapper;
  ...
  public String generateCodeForCourse(String courseId, Long teacherId) {
    try {
      ...
      log.error(
          "为课程生成邀请码失败: courseId={}, teacherId={}, error={}",
          courseId,
          teacherId,
          e.getMessage(),
          e);
  ...
  public void createTeacherInvitationCode(
      CreateTeacherInvitationCodeDTO createTeacherInvitationCodeDTO) {
