...
public class StreamingNodeCreator {
   ...
   */
  public void processStreamingToken(WorkContext workContext, String token)
  ...
  private void updateNodeContent(
    ...
    try {
      ...
      redisStream.add(StreamAddArgs.entries("type", AiTaskMessageType.TEXT, "data", textData));
    } catch (Exception e) {
  ...
  private void insertAndPublishNode(
    ...
    try {
      ...
      redisStream.add(StreamAddArgs.entries("type", AiTaskMessageType.NODE, "data", data));
    } catch (Exception e) {
