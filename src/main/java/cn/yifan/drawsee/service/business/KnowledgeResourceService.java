...
public class KnowledgeResourceService {
  ...
  public String uploadResource(UploadResourceDTO uploadResourceDTO, MultipartFile file) {
    ...
    log.info(
        "开始上传资源: resourceType={}, originalFilename={}, contentType={}, size={}",
        resourceType,
        originalFilename,
        file.getContentType(),
        file.getSize());
  ...
  /** 添加B站视频资源 */
  @Transactional
  public String addBilibiliResource(
  ...
  /** 获取知识库特定类型资源列表 */
  public List<KnowledgeResource> getResourcesByKnowledgeBaseIdAndType(
      String knowledgeBaseId, String resourceType) {
    if (!StringUtils.hasText(knowledgeBaseId) || !StringUtils.hasText(resourceType)) {
      return Collections.emptyList();
    }
    return knowledgeResourceMapper.getByKnowledgeBaseIdAndType(
        knowledgeBaseId, resourceType, false);
  }
  ...
  public Map<String, Integer> countResourcesByKnowledgeBaseId(String knowledgeBaseId) {
    ...
    List<Map<String, Object>> results =
        knowledgeResourceMapper.countResourcesByKnowledgeBaseId(knowledgeBaseId);
  ...
  private String getObjectName(
      String resourceType, String knowledgeBaseId, String originalFilename) {
    return "knowledge/"
        + knowledgeBaseId
        + "/"
  ...
  public String uploadDocumentResource(UploadResourceDTO uploadResourceDTO, MultipartFile file) {
    ...
    log.info(
        "开始上传文档资源: resourceType={}, originalFilename={}, contentType={}, size={}",
        resourceType,
        originalFilename,
        file.getContentType(),
        file.getSize());
  ...
  public String uploadVideoResource(UploadResourceDTO uploadResourceDTO, MultipartFile file) {
    ...
    log.info(
        "开始上传视频资源: resourceType={}, originalFilename={}, contentType={}, size={}",
        resourceType,
        originalFilename,
        file.getContentType(),
        file.getSize());
  ...
  public Map<String, Integer> getResourceCountByTypes(String knowledgeBaseId) {
    ...
    List<KnowledgeResource> resources =
        knowledgeResourceMapper.getByKnowledgeBaseId(knowledgeBaseId, false);
