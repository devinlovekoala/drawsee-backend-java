...
/**
 * @FileName UserService @Description @Author yifan
 *
...
public class UserService {
  ...
  private LoginVO getLoginVO(User user) {
    ...
    return new LoginVO(tokenInfo.tokenValue, user.getUsername(), counter.get(), aiTaskLimit);
  }
  ...
  public LoginVO signup(UserSignUpDTO userSignUpDTO) {
    ...
    user = new User(userSignUpDTO.getUsername(), PasswordUtil.encode(userSignUpDTO.getPassword()));
