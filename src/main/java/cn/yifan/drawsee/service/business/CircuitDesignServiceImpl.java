...
/**
 * @FileName CircuitDesignServiceImpl @Description 电路设计服务实现类 @Author yifan
 *
...
public class CircuitDesignServiceImpl implements CircuitDesignService {
  ...
  @Autowired private CircuitDesignMapper circuitDesignMapper;
  ...
  @Override
  public Map<String, Object> updateCircuitDesign(
      Long userId, Long id, CircuitDesign circuitDesign) {
    Map<String, Object> result = new HashMap<>(2);
