...
public class KnowledgeDocumentService {
    ...
    public RagIngestionTask createDocument(KnowledgeDocument document, Long uploaderId) {
        ...
        log.info("知识库文档元数据写入成功: knowledgeBaseId={}, documentId={}, uploaderId={}",
            document.getKnowledgeBaseId(), document.getId(), uploaderId);
    ...
    public List<KnowledgeDocument> listDocuments(String knowledgeBaseId) {
        List<KnowledgeDocument> list = knowledgeDocumentMapper.listByKnowledgeBaseId(knowledgeBaseId, false);
    ...
    public void updateStatus(String documentId, KnowledgeDocumentStatus status, String failureReason) {
