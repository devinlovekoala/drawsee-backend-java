...
public class RagIngestionTaskService {
  ...
  @Autowired private RagIngestionTaskMapper ragIngestionTaskMapper;
  ...
  public List<RagIngestionTask> listTasks(
      ...
      int offset,
      int limit) {
    return ragIngestionTaskMapper.listTasks(
        knowledgeBaseId, documentId, stage, status, offset, limit);
  }
