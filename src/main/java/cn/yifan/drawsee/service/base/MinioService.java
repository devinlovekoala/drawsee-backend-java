...
/**
 * @FileName MinioService @Description Minio服务类，处理文件上传下载等操作 @Author yifan
 *
...
public class MinioService {
  ...
  public String uploadImage(java.awt.image.BufferedImage image, String objectName)
      throws MinioException, IOException, NoSuchAlgorithmException, InvalidKeyException {
  ...
  public String uploadFile(MultipartFile file, String objectName)
    ...
    minioClient.putObject(
        PutObjectArgs.builder().bucket(minioConfig.getBucketName()).object(objectName).stream(
            ...
            .build());
    log.info(
        "MinIO 文件上传成功: bucket={}, object={}, size={}",
  ...
  public String getObjectBase64(String objectName, int maxBytes)
      throws MinioException, IOException, NoSuchAlgorithmException, InvalidKeyException {
  ...
  public GetObjectResponse getObjectStream(String objectName)
      throws MinioException, IOException, NoSuchAlgorithmException, InvalidKeyException {
    return minioClient.getObject(
        GetObjectArgs.builder().bucket(minioConfig.getBucketName()).object(objectName).build());
  }
