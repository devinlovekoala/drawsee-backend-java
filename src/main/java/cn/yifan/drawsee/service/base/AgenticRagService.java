...
/**
 * Agentic RAG v2 服务 对接Python Agentic RAG系统，提供SSE流式查询
 *
 * @author Drawsee Team
 */
@Service
...
public class AgenticRagService {
    ...
    executorService.execute(
        () -> {
          try {
            ...
            // 构建请求体
            AgenticQueryRequest request =
                AgenticQueryRequest.builder()
                    .query(query)
  ...
  public Map<String, Object> getChannelsStatus(Long userId, String classId) {
    ...
    HttpEntity<?> entity = new HttpEntity<>(createAuthHeaders(userId, classId, null));
  ...
  private String objectToJson(AgenticQueryRequest request) {
    ...
    json.append("],");
    json.append("\"has_image\":")
        .append(request.getHasImage() != null ? request.getHasImage() : false)
        .append(",");
