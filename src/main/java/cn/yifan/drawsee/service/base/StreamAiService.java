...
public class StreamAiService {
    ...
    public void knowledgeDetailChat(List<ChatMessage> history, String knowledgePoint, StreamingResponseHandler<AiMessage> handler) {
        LinkedList<ChatMessage> messages = new LinkedList<>(history);
    ...
    public void animationChat(List<ChatMessage> history, String question, StreamingResponseHandler<AiMessage> handler) {
        LinkedList<ChatMessage> messages = new LinkedList<>(history);
    ...
    public void solverFirstChat(List<ChatMessage> history, String question, String method, StreamingResponseHandler<AiMessage> handler) {
        LinkedList<ChatMessage> messages = new LinkedList<>(history);
    ...
    public void solverContinueChat(List<ChatMessage> history, StreamingResponseHandler<AiMessage> handler) {
        LinkedList<ChatMessage> messages = new LinkedList<>(history);
    ...
    public void solverSummaryChat(List<ChatMessage> history, StreamingResponseHandler<AiMessage> handler) {
        LinkedList<ChatMessage> messages = new LinkedList<>(history);
    ...
    public void plannerFirstChat(List<ChatMessage> history, StreamingResponseHandler<AiMessage> handler) {
        LinkedList<ChatMessage> messages = new LinkedList<>(history);
    ...
    public void htmlMakerChat(List<ChatMessage> history, String question, StreamingResponseHandler<AiMessage> handler) {
        LinkedList<ChatMessage> messages = new LinkedList<>(history);
