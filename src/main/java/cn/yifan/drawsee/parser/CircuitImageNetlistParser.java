...
public class CircuitImageNetlistParser {
  ...
  private static final Set<String> POWER_ELEMENT_TYPES =
      Set.of("dc_source", "ac_source", "current_source");
  ...
  private static Map<String, List<PortTemplate>> createPortTemplates() {
    ...
    map.put("digital_input", List.of(new PortTemplate("out", "out", "output", "right", 100, 50)));
    map.put("digital_output", List.of(new PortTemplate("in", "in", "input", "left", 0, 50)));
    map.put("digital_clock", List.of(new PortTemplate("out", "out", "output", "right", 100, 50)));
    map.put(
        "digital_not",
        List.of(
    ...
    map.put(
        "resistor",
        List.of(
            new PortTemplate("port1", "port1", "bidirectional", "left", 0, 50),
            new PortTemplate("port2", "port2", "bidirectional", "right", 100, 50)));
    map.put("capacitor", map.get("resistor"));
    map.put("inductor", map.get("resistor"));
    map.put(
        "diode",
        List.of(
            new PortTemplate("anode", "anode", "input", "left", 0, 50),
            new PortTemplate("cathode", "cathode", "output", "right", 100, 50)));
    map.put(
        "bjt",
        List.of(
            new PortTemplate("base", "base", "input", "left", 0, 50),
            new PortTemplate("collector", "collector", "output", "right", 100, 25),
            new PortTemplate("emitter", "emitter", "output", "right", 100, 75)));
    map.put("bjt_pnp", map.get("bjt"));
    map.put(
        "dc_source",
        List.of(
    ...
    map.put("ground", List.of(new PortTemplate("ground", "ground", "input", "top", 50, 0)));
    map.put(
        "opamp",
        List.of(
  ...
  private record PortTemplate(
      String id, String name, String type, String side, double x, double y) {}
}
