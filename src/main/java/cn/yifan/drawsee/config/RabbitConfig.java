...
import cn.yifan.drawsee.pojo.rabbit.ConfigModel;
import cn.yifan.drawsee.pojo.rabbit.ConfigQueue;
...
public class RabbitConfig {
    ...
    @Bean
    // 显示声明才能创建
    public RabbitAdmin rabbitAdmin(ConnectionFactory connectionFactory, List<LinkedQueue> aiTaskQueues, List<LinkedQueue> animationTaskQueues) {
    ...
    private void declareExchangeAndQueues(List<LinkedQueue> taskQueues, RabbitAdmin admin, MqConfig mqConfig) {
